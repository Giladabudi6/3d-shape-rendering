package renderer.CameraIntegrationTests;
...
public class CameraIntegrationTests {
     ...
     * if there are intersections we will save the intersection points in the list.
     * we will call this method in any of the following tests
     */
    private int countIntersectionsCameraGeometry(Camera camera, Intersectable geometry, int Nx, int Ny) {
        int count = 0;
    ...
    void testCameraSphereIntegration() {
        ...
        assertEquals(2,
                countIntersectionsCameraGeometry(camera1, new Sphere(1, new Point(0, 0, -3)), 3, 3),
                "Wrong number of intersections");

        //TC02: Sphere r=2.5 (18 intersections)
        assertEquals(18, countIntersectionsCameraGeometry(camera2, new Sphere(2.5, new Point(0, 0, -2.5)), 3, 3), "Wrong number of intersections");
        ...
        assertEquals(0, countIntersectionsCameraGeometry(camera1, new Sphere(0.5, new Point(0, 0, 1)), 3, 3), "Wrong number of intersections");
    ...
    void testCameraPlaneIntegration() {
        ...
        Camera camera1 = new Camera(zeroPoint, new Vector(0, 0, -1), new Vector(0, -1, 0));
        camera1.setVPSize(3d, 3d);
        camera1.setVPDistance(1d);


        //TC06: Plane normal=(0,-1,0) (9 intersections)
        assertEquals(9, countIntersectionsCameraGeometry(camera1, new Plane(new Point(0, 0, -3), new Vector(0, 0, 1)), 3, 3), "Wrong number of intersections");

        //TC07: Plane normal=(0,-1,0.5) (9 intersections)
        assertEquals(9, countIntersectionsCameraGeometry(camera1, new Plane(new Point(0, 0, -2), new Vector(0, -1, 2)), 3, 3), "Wrong number of intersections");

        //TC08: Plane normal=(0,-1,1) (6 intersections)
        assertEquals(6, countIntersectionsCameraGeometry(camera1, new Plane(new Point(0, 0, -2), new Vector(0, -1, 0.5)), 3, 3), "Wrong number of intersections");
    ...
    void testCameraTriangleIntegration() {
        ...
        assertEquals(1, countIntersectionsCameraGeometry(camera1, new Triangle(new Point(0, 1, -2), new Point(1, -1, -2), new Point(-1, -1, -2)), 3, 3), "Wrong number of intersections");

        //TC10: Triangle (2 intersections)
        assertEquals(2, countIntersectionsCameraGeometry(camera1, new Triangle(new Point(0, 20, -2), new Point(1, -1, -2), new Point(-1, -1, -2)), 3, 3), "Wrong number of intersections");
